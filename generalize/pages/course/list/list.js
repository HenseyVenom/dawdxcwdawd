...
Page({
  ...
  enterDeatil: function(e) {
    var i = e.currentTarget.dataset.i
    wx.navigateTo({
      url: '/pages/receive/course/course?id=' + this.data.list[i].id,
    })
  },
  ...
  getPageList: function() {
    ...
    var url = 'front/unAuth/organShop/shopCourse/courseList?page=' + this.data.pO.page + '&size=' + this.data.pO.size + "&special=true"
