...
Page({
  ...
  bankCardItem: function(res) {
    if (this.data.isChooseType) {
      ...
      wx.navigateTo({
        url: '/pages/bankCard/bankCardUnbinding/bankCardUnbinding?bankName=' + this.data.bankCard.bankName + '&cardNumber=' + this.data.bankCard.cardNumber + '&bankUrl=' + this.data.bankimgurl,
      })
    }
  },
  getUserData() {
